...
import { Power, Square, Play, Pause, AlertTriangle, Shield, Settings } from "lucide-react";
  ...
  return <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <Button variant={controlState.emergencyStop ? "destructive" : "outline"} size="lg" onClick={onEmergencyStop} className="w-full">
            <Square className="h-4 w-4 mr-2" />
            {controlState.emergencyStop ? 'EMERGENCY ACTIVE' : 'EMERGENCY STOP'}
          </Button>

          <Button variant="outline" size="sm" onClick={onResetProtection} disabled={!controlState.protectionMode} className="w-full">
          ...
          <div className="flex items-center justify-between">
            ...
            <Badge variant={controlState.protectionMode ? "destructive" : "secondary"}>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              <Switch checked={mosfetStatus.qc} onCheckedChange={checked => onMosfetToggle('qc', checked)} disabled={controlState.emergencyStop} />
            ...
            <div className="flex items-center gap-2">
              <Switch checked={mosfetStatus.qd1} onCheckedChange={checked => onMosfetToggle('qd1', checked)} disabled={controlState.emergencyStop} />
              <div className="w-3 h-3 rounded-full" style={{
            ...
            <div className="flex items-center gap-2">
              <Switch checked={mosfetStatus.qd2} onCheckedChange={checked => onMosfetToggle('qd2', checked)} disabled={controlState.emergencyStop} />
              <div className="w-3 h-3 rounded-full" style={{
            ...
            <div className="flex items-center gap-2">
              <Switch checked={mosfetStatus.qd3} onCheckedChange={checked => onMosfetToggle('qd3', checked)} disabled={controlState.emergencyStop} />
              <div className="w-3 h-3 rounded-full" style={{
